    ...
    return (
        <div className="container mt-4">
            ...
            <div>
                ...
                <div className="row">
                    <div className="col-2 text-center"><strong>Name</strong> <br />{planet?.name}</div>
                    <div className="col-2 text-center"><strong>Rotation Period</strong> <br /> {planet?.rotation_period}</div>
                    <div className="col-2 text-center"><strong>Orbital Period</strong> <br /> {planet?.orbital_period}</div>
                    <div className="col-2 text-center"><strong>Diameter</strong> <br /> {planet?.diameter}</div>
                    <div className="col-2 text-center"><strong>Climate</strong> <br /> {planet?.climate}</div>
                    <div className="col-2 text-center"><strong>gravity</strong> <br /> {planet?.gravity}</div>
                </div>
            </div>
        </div>
    );
